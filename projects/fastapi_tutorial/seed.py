...
⚠️ NINE of the eighteen slugs were published in June 2023 and therefore already carry dates that
upsert_post will not overwrite. `--force-dates` stamps the manifest date onto an existing post
before upserting it, which is what makes the rewritten track read in lesson order. Without it the
archive interleaves nine 2026 posts with nine 2023 ones and the pager reads nonsense.
