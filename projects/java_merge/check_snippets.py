...
block so a failure is debuggable rather than mysterious.
    ...
    python projects/java_merge/check_snippets.py
    python projects/java_merge/check_snippets.py --show java-stream:3
    python projects/java_merge/check_snippets.py --jdk21-only   # skip the 25 pass
"""
