#!/usr/bin/env python3
"""Write the Java category and its posts into a content tree.
...
build reads only the indexes.
    ...
    python projects/java_tutorial/seed.py

    python projects/java_tutorial/seed.py --env local --write
    python projects/java_tutorial/seed.py --env prod  --write
