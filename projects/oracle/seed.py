#!/usr/bin/env python3
"""Write the Oracle category and its posts into a content tree.
...
build reads only the indexes.
    ...
    python projects/oracle/seed.py

    python projects/oracle/seed.py --env local --write
    python projects/oracle/seed.py --env prod  --write
