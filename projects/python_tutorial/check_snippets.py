...
doctest instead, which compares every result exactly.
    ...
    python3 projects/python_tutorial/check_snippets.py
    python3 projects/python_tutorial/check_snippets.py --show python-tuples:3
    python3 projects/python_tutorial/check_snippets.py --baseline-only
"""
...
def main() -> int:
    ...
    for entry in manifest.POSTS:
        ...
        bits = ([f"{pinned} pinned to {LATEST}"] if pinned else []) + \
