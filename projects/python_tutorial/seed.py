#!/usr/bin/env python3
"""Write the Python category and its posts into a content tree.
...
build reads only the indexes.
    ...
    python projects/python_tutorial/seed.py

    python projects/python_tutorial/seed.py --env local --write
    python projects/python_tutorial/seed.py --env prod  --write
